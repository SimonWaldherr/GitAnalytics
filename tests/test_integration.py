...
class IntegrationTests(unittest.TestCase):
    ...
    def test_end_to_end_cache_and_read_only(self) -> None:
        ...
        self.assertEqual(report["summary"]["new_authors_last_30_days"], 0)
        self.assertEqual(report["summary"]["repositories_with_ci"], 1)
        self.assertEqual(report["summary"]["repositories_with_license"], 1)
        self.assertEqual(report["summary"]["ci_coverage"], 1)
        self.assertEqual(report["summary"]["license_coverage"], 1)
